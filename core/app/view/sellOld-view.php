									...
									<div class="col-md-12">
										...
										<div class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="money"
														class="col-lg-8 control-label">PAGO PARCIAL:</label>
													<div class="col-lg-10">
														<input type="number" name="pagoParcial" class="form-control"
															id="pagoParcial" placeholder="PAGO PARCIAL" step="any"
															value="0">
													</div>
												</div>
											</div>
															...
															<tr>
																...
																<td>
																	...
																	if ($product->description != "" && $product->description != "-") {
																		echo "<b>(" . $product->description . '-' . $product->laboratorio. ")</b>";
																	}elseif($p["descripcion"] !="" && $p["descripcion"] !="-"){
																		echo "<b>(" . $p["descripcion"] . '-' . $product->laboratorio. ")</b>";
																	}
																	?>
																</td>
