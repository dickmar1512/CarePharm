...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0"><i class='fa fa-archive'></i> Registro de notas Ventas</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Reportes</a></li>
					<li class="breadcrumb-item active">Registro de notas Ventas</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12">
						...
						$tc = 0; // Total de capital
						$tv = 0; // Total de ventas
									...
									<tr>
										<td style="width:30px;">
											...
											if ($sell->tipo_comprobante == 3) {
												if ($sell->estado == 1) {
													?>
													<a href="./?view=onesellc&id=<?php echo $sell->id; ?>"
														class="btn btn-xs btn-default"><i class="fas fa-eye"></i></a>
													<?php
												} else {
													?>
													<a href="./?view=onesellf&id=<?php echo $sell->id; ?>"
														class="btn btn-xs btn-default"><i class="fas fa-eye"></i></a>
													<?php
												}
											} else {
												if ($sell->tipo_comprobante == 1) {
													if ($sell->estado == 1) {
														?>
														<a href="./?view=onesell2c&id=<?php echo $sell->id; ?>"
															class="btn btn-xs btn-default"><i class="fas fa-eye"></i></a>
														<?php
													} else {
														?>
														<a href="./?view=onesell2f&id=<?php echo $sell->id; ?>"
															class="btn btn-xs btn-default"><i class="fas fa-eye"></i></a>
														<?php
													}
												} else { ?>
