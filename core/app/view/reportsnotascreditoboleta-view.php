					...
					?>
						<tr>
							...
							<td class="text-center boton">
								...
								<a href="index.php?view=notacreditoboletat&num=<?php echo $nota_credito->SERIE . '-' . $nota_credito->COMPROBANTE ?>" class="btn btn-info btn-xs"><i class="fa fa-file">Ver</i></a>
							</td>
						</tr>
					<?php
