...
if ($kit != null):
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <br><br>
      <form class="form-horizontal" method="post" id="addkitt" enctype="multipart/form-data" action="./?view=updatekit"
        role="form">
      ...
      <table class="table table-bordered table-hover">
        ...
        <?php foreach ($detkit as $detalle): ?>
          <tr>
            ...
            <td style="width:70px;">
              <a href="./?view=deldetkit&id=<?= $kit->idpaquete ?>&iddet=<?= $detalle->iddetalle ?>"
