...
<fieldset class="content-group">
		...
		<table class="table"  id="alt">
				<thead class="thead-dark">
					...
					<th scope="col" style="border: 1px solid black; width: 400px">DESCUENTO</th>
							...
							?>
								<tr>
									...
									<td ><p id="p<?php echo $i; ?>"><input id="pronuevo<?php echo $i; ?>" type="hidden" value=""></p>
										<p>Dscto: <input type="number" id="descuento<?php echo $i; ?>"></p>
									</td>
...
$("#fin").click(function () {
		...
		for (var i = 0; i < cont; i++) {
			if($("#descuento"+i).val()!=''){
				arraydet.push([$("#proviejo"+i).val(),$("#descuento"+i).val()]);
			}
		}
